...
export default function RadialOrbitalTimeline({
  ...
  const getStatusStyles = (status: TimelineItem["status"]): string => {
    switch (status) {
      ...
      case "in-progress":
        return "bg-secondary text-foreground border-foreground/30";
      case "pending":
  ...
  return (
    ...
    >
      <div className="relative w-full max-w-4xl h-full flex items-center justify-center">
        ...
        >
          {/* Center orb — monochrome */}
          <div className="absolute w-14 h-14 rounded-full bg-foreground animate-pulse flex items-center justify-center z-10">
            <div className="absolute w-18 h-18 rounded-full border-2 border-foreground/15 animate-ping opacity-60"></div>
            <div className="w-6 h-6 rounded-full bg-background"></div>
          </div>

          {/* Orbit ring */}
          <div className="absolute w-96 h-96 rounded-full border border-foreground/15"></div>
            ...
            return (
              ...
              >
                ...
                <div
                  ...
                  ${
                    isExpanded
                      ? "border-foreground shadow-lg shadow-foreground/15"
                      : isRelated
